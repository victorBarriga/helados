            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                          <h5>Sección de reportes - Compras</h5>
                    </div>
                    <!-- Listado-->
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-2">
                                    ...
                                    <input class="form-control" type="date" v-model="initDate" >
                                </div>
                                <div class="col-12 col-md-2">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <button  type="submit" @click="listarIngreso2(1,initDate,endDate)" class="btn btn-success">Buscar</button>
                                    <button  type="submit" @click="generateReport(1,initDate,endDate)" class="btn btn-primary">Imprimir A4</button>
                                    <button  type="submit" @click="generateReportTermic()" class="btn btn-secondary">Imprimir Termica</button>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            listarIngreso2 (page,buscar,criterio){
                let me=this;
                this.url= '/report-compra';
                var idproveedor = this.idproveedor;
               if((idproveedor == 0  || idproveedor == null ) && this.initDate == '' && this.endDate == '' )
                {
                     this.url= '/report-compra';
                }
                if(this.initDate !== '' && this.endDate !== '' && (idproveedor == 0  || idproveedor == null )  )
                {
                    this.url= '/report-compra?initDate='+ this.initDate + '&endDate=' + this.endDate;
                }
                if(idproveedor !== null && this.initDate !== '' && this.endDate !== '' && (idproveedor != 0) )
                {
                    this.url= '/report-compra?initDate='+ this.initDate + '&endDate=' + this.endDate + '&idproveedor='+idproveedor;
                }
                if(idproveedor != null && this.initDate == '' && this.endDate == '' &&  idproveedor != 0)
                {
                    this.url= '/report-compra?idproveedor='+idproveedor;
                }
            ...
            {  
                ...
                if(this.initDate !== '' && this.endDate !== '' && (idproveedor == 0  || idproveedor == null )  )
                {
                    this.url= '/pdf-compra?initDate='+ this.initDate + '&endDate=' + this.endDate;
                }
                if(idproveedor !== null && this.initDate !== '' && this.endDate !== '' && (idproveedor != 0) )
                {
                    this.url= '/pdf-compra?initDate='+ this.initDate + '&endDate=' + this.endDate + '&idproveedor='+idproveedor;
                }
                if(idproveedor != null && this.initDate == '' && this.endDate == '' &&  idproveedor != 0)
                {
                    this.url= '/pdf-compra?idproveedor='+idproveedor;
                }
                ...
                //         link.href = url;
                //         link.setAttribute('download', 'reportes-compras.pdf');
            ...
            generateReportTermic(){
                ...
                if(this.initDate !== '' && this.endDate !== '' && (idproveedor == 0  || idproveedor == null )  )
                {
                    this.url= '/pdf-compra-termic?initDate='+ this.initDate + '&endDate=' + this.endDate;
                }
                if(idproveedor !== null && this.initDate !== '' && this.endDate !== '' && (idproveedor != 0) )
                {
                    this.url= '/pdf-compra-termic?initDate='+ this.initDate + '&endDate=' + this.endDate + '&idproveedor='+idproveedor;
                }
                if(idproveedor != null && this.initDate == '' && this.endDate == '' &&  idproveedor != 0)
                {
                    this.url= '/pdf-compra-termic?idproveedor='+idproveedor;
                }
                window.open(this.url, '_blank');
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.listarIngreso2(page,buscar,criterio);
            },
            encuentra(id){
                var sw=0;
                for(var i=0;i<this.arrayDetalle.length;i++){
            ...
            registrarIngreso(){
                ...
                axios.post('/ingreso/registrar',{
                    ...
                    me.listado=1;
                    me.listarIngreso2(1,'','num_comprobante');
                    me.idproveedor=0;
        ...
        mounted() {
            this.listarIngreso2(1,this.buscar,this.criterio);
        }
    }
</script>
<style>    
