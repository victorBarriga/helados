            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Tipo de Inventarios
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="tipo in arrayTipo" :key="tipo.id_tipo_inventario">
                                    
                                    <td v-text="tipo.id_tipo_inventario"></td>
    ...
    export default {
        ...
        methods : {
            listarRol (page,buscar,criterio){
                let me=this;
                var url= '/tipo-inventario';
                axios.get(url).then(function (response) {
    
                    var respuesta= response.data;
                    me.arrayTipo = respuesta.tipo_inventario.data;
