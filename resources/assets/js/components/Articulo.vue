                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    ...
                                    <td>
                                        <div v-if=" articulo.stock < 6 ">
                                            <span class="badge badge-warning">{{articulo.stock }} <i class="fa fa-warning"></i></span>
                                        </div>
                                        <div v-else>
    ...
    export default {
        ...
        methods : {
            ...
            validarArticulo(){
                ...
                if (!this.stock) this.errorMostrarMsjArticulo.push("El stock del insumo debe ser un número y no puede estar vacío.");
                if (!this.precio_venta) this.errorMostrarMsjArticulo.push("El precio del insumo debe ser un número y no puede estar vacío.");
