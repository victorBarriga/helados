            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Insumos 10
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <!-- <div class="col-md-3">
                                <div class="input-group">
                                    <button type="submit" @click="listarInsumo(1,'default','limit')" class="btn btn-warning"><i class="fa fa-warning"></i> Filtrar - Pocos</button>                        
                                    <button type="submit" @click="listarInsumo(1,'','')" class="btn btn-success"><i class="fa fa-trash"></i> Borrar Filtro</button>                        
                                </div>
                            </div> -->
                        </div>
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="insumo in arrayInsumos" :key="insumo.id_insumo">
                                    ...
                                    <td v-text="insumo.precio"></td>
                                    <td>
                                        <div v-if=" insumo.cantidad < 6 ">
                                            <span class="badge badge-warning">{{insumo.cantidad }} <i class="fa fa-warning"></i></span>
                                        </div>
                                        <div v-else>
                                            <span class="badge badge-success">{{insumo.cantidad}}</span>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="id_categoria">
                                            ...
                                            <option v-for="categoria in arrayCategoria" :key="categoria.id_categoria" :value="categoria.id_categoria" v-text="categoria.nombre"></option>
                                        </select>                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="id_almacen">
                                            <option value="0" disabled>Seleccione</option>
                                            <option v-for="almacen in arrayAlmacen" :key="almacen.id_almacen" :value="almacen.id_almacen" v-text="almacen.direccion"></option>
                                        </select>                                        
                                    </div>
                                </div>
                                <div class="form-group row">
    ...
    export default {
        ...
        methods : {
            ...
            validarInsumo(){
                ...
                if (this.id_categoria==0) this.errorMostrarMsjArticulo.push("Seleccione una categoría.");
                if (!this.nombre) this.errorMostrarMsjArticulo.push("El nombre del insumo no puede estar vacío.");
                if (!this.cantidad) this.errorMostrarMsjArticulo.push("El cantidad del insumo debe ser un número y no puede estar vacío.");
