            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h5>Sección de reportes</h5>
                     <!-- <a class="btn btn-secondary" href="report-venta">Generar Reporte </a>  -->
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <button  type="submit" @click="listarVenta2(1,initDate,endDate)" class="btn btn-success"><i class="fa fa-search"></i> Buscar</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row border">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Artículo <span v-show="idarticulo==0">(*Seleccione)</span></label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Precio <span  v-show="precio==0">(*Ingrese)</span></label>
                                    <input type="number" value="0" step="any" class="form-control" v-model="precio">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Cantidad <span  v-show="cantidad==0">(*Ingrese)</span></label>
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            ...
                                            <td>
                                                <span  v-show="detalle.cantidad>detalle.stock">Stock: {{detalle.stock}}</span>
                                                <input v-model="detalle.cantidad" type="number" class="form-control">
                                            </td>
                                            <td>
                                                <span  v-show="detalle.descuento>(detalle.precio*detalle.cantidad)">Descuento superior</span>
