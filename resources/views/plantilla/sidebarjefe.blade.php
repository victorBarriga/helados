            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li @click="menu=0" class="nav-item">
                        <a class="nav-link active" href="#"><i class="fa fa-cart-arrow-down"></i> JEFE PRODUCCIÓN</a>
                    </li>
                    <li class="nav-title">
                        --------------------------------
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li @click="menu=105" class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-basket-loaded"></i>Productos</a>
                            </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-basket"></i> Cronograma Diario</a>
                        <ul class="nav-dropdown-items">
                            <li @click="menu=104" class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-basket-loaded"></i> Gestion de cronograma</a>
                            </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li @click="menu=101" class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-basket-loaded"></i> Insumos</a>
                            </li>
                        </ul>
                    </li>
                    <!--=======================================================================-->                    
