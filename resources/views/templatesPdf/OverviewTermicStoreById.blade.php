...
<body>
    ...
    <table>
      ...
      <!-- <table>
        <tfoot>
          <tr>
            <th scope="row" colspan="2">Serie Comprobante : </th>
            <td colspan="2"><?php print_r($valor['venta']->serie_comprobante) ?> </td>
          </tr>
        </tfoot>
      </table> -->
      <table>
    ...
    <table  class="table-bordered">
        ...
        <tr class="table-bordered">
         ...
         <tr class="table-bordered" style="font-weight: 700">
            <td class="table-bordered"  style="text-align:right !important;" colspan="5">Total :<?php print_r($valor['total']) ?> </td>
        </tr>
      </table>
   <br>
   <br>
